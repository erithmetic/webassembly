...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'vyubi.wast';
  var wasmBinaryFile = 'vyubi.wasm';
  var asmjsCodeFile = 'vyubi.temp.asm.js';
...
var real__ykgenerate = asm["_ykgenerate"]; asm["_ykgenerate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__ykgenerate.apply(null, arguments);
};
...
var _ykgenerate = Module["_ykgenerate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_ykgenerate"].apply(null, arguments) };
